...
window.onload = function () { "use strict"; gaSSDSLoad("UA-1894480-2"); }; //load after page onload
/*************** REPLACE WITH YOUR OWN UA NUMBER ***********/
...
$(document).ready(function() {
    ...
    */
    ...
    if($('#homeCarousel').length){
    	...
    	{
    		items:1, 				//items:$(this).data('neko_items'),			
			stopOnHover : true,
		    mouseDrag : true,
		    touchDrag : true,			
    		navigation: false,
			...
			autoPlay:10000,
			goToFirst: false,  //Slide to first item if autoPlay reach end
			goToFirstSpeed:20000 //Slide speed of goToFirst option in milliseconds
    	});
...
jQuery(function() {
	...
	/* DOWNLOAD FORM */	
	if( jQuery("#downloadfrm").length ){

		jQuery("#downloadfrm").validate({
        // debug: true,
        errorPlacement: function(error, element) {
        	error.insertBefore( element );
        },
